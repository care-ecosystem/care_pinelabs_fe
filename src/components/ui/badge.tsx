  ...
  "inline-flex items-center rounded-md border border-gray-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-hidden focus:ring-2 focus:ring-gray-950 focus:ring-offset-2 dark:border-gray-800 dark:focus:ring-gray-300",
  {
    variants: {
      variant: {
        ...
        info:
          "border-blue-300 bg-blue-100 text-blue-900 hover:bg-blue-100/80 dark:bg-blue-900 dark:text-gray-50 dark:hover:bg-blue-900/80",
        caution:
          "border-amber-300 bg-amber-100 text-amber-900 hover:bg-amber-100/80 dark:bg-amber-900 dark:text-gray-50 dark:hover:bg-amber-900/80",
      },
    },
    defaultVariants: {
      variant: "default",
